...
"Plug 'jparise/vim-graphql' " syntax highlighting for graphql schemas
...
"let g:ale_fixers = {'*': ['remove_trailing_lines', 'trim_whitespace'], 'elixir': ['mix_format'], 'javascript': js_fixers, 'typescript': js_fixers, 'typescriptreact': js_fixers, 'ruby': ['rubocop'], 'python': ['black']}
